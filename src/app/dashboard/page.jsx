...
const DashboardPage = () => {
  const stats = [
    { label: "Total Posts", value: "1,247", change: "+12%", icon: Send },
    { label: "Engagement Rate", value: "4.7%", change: "+2.1%", icon: TrendingUp },
    { label: "Followers", value: "28.4K", change: "+347", icon: Users },
    { label: "Scheduled", value: "15", change: "+5", icon: Calendar }
  ];

  const recentPosts = [
    { platform: "Twitter", content: "Just launched our new feature! 🚀", time: "2 hours ago", engagement: "245" },
    { platform: "Facebook", content: "Check out our latest update...", time: "5 hours ago", engagement: "189" },
    { platform: "Instagram", content: "Behind the scenes at PostHub 📸", time: "1 day ago", engagement: "1.2K" }
  ];
