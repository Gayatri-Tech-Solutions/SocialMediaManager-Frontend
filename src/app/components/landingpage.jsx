  ...
  return (
    ...
    <div className="text-white bg-black">
      ...
      <section className="py-20 sm:py-32 bg-black text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          PostHub unifies your social platforms—Twitter, Facebook, and Instagram—allowing you to create, update, and control every post from one smart dashboard.</p>

          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#signup"  className="px-8 py-3 bg-yellow-600 text-black font-bold text-lg rounded-xl shadow-xl hover:bg-yellow-500 transition cursor-pointer">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <h2 className="text-4xl font-bold">
                Built for <span className="text-yellow-600">Creators</span>, by Creators
              </h2>
              
              <p className="text-lg text-gray-300 leading-relaxed">
                PostHub was built to solve a problem every creator faces—too many tabs, 
                too many apps, and too much time wasted managing social media.
              </p>

              <p className="text-lg text-gray-300 leading-relaxed">
                We created a platform where content comes first: a single place where you can post, 
                update, and track everything across Twitter, Facebook, and Instagram instantly.
              </p>

              <p className="text-lg text-gray-300 leading-relaxed">
                At PostHub, we're driven by innovation, simplicity, and a passion for empowering 
                creators to grow without friction.
              </p>
            ...
            <div className="relative">
              <div className="bg-black/60  rounded-2xl p-8 border border-gray-800 ">
                <h3 className="text-2xl font-bold text-center mb-8 text-white">
                  Why Creators Love Post<span className="text-yellow-600">Hub</span>
                </h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between p-4  rounded-lg border border-gray-800">
                    ...
                    <span className="text-2xl font-bold text-yellow-600">5+ hrs/wk</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-4  rounded-lg border border-gray-800">
                    ...
                    <span className="text-2xl font-bold text-yellow-600">10K+</span>
                  </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-400 mb-3">Join thousands of creators</p>
                  <a href="#signup" className="inline-block px-6 py-2 bg-yellow-600 text-black font-bold rounded-lg hover:bg-yellow-500 transition cursor-pointer">
                    Start Today
                  </a>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="text-center p-6 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 hover:border-yellow-500 transition">
              ...
              <p className="text-gray-400">
                Securely link all your accounts (Twitter, Facebook, Instagram) in one session.
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 hover:border-yellow-500 transition">
              ...
              <h3 className="text-xl font-bold mb-2">2. Single-Click Publish</h3>
              <p className="text-gray-400">
                Write content once, and instantly publish across all platforms.
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 hover:border-yellow-500 transition">
              ...
              <h3 className="text-xl font-bold mb-2">3. Review & Read Posts</h3>
              <p className="text-gray-400">
            ...
            <div className="text-center p-6 bg-gray-900 rounded-xl shadow-2xl border border-gray-700 hover:border-yellow-500 transition">
              ...
              <h3 className="text-xl font-bold mb-2">4. Full Post Management</h3>
              <p className="text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Fair pricing based on actual API costs. No hidden fees. Cancel anytime.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-yellow-500 transition-all duration-300 hover:transform hover:scale-105">
              <div className="text-center mb-8">
                ...
                <p className="text-yellow-600 text-sm mt-2">Perfect for testing</p>
              </div>
              ...
              <a href="#signup"  className="w-full block text-center py-3 border-2 border-yellow-600 text-yellow-600 font-bold rounded-xl hover:bg-yellow-600 hover:text-black transition cursor-pointer">
                Get Started Free
              </a>
            </div>
            ...
            <div className="bg-black rounded-2xl p-8 border-2 border-yellow-600 relative hover:transform hover:scale-105 transition-all duration-300">
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-yellow-600 text-sm mt-2">Includes API costs</p>
              </div>
              ...
              <a href="#signup" className="w-full block text-center py-3 bg-yellow-600 text-black font-bold rounded-xl hover:bg-yellow-500 transition cursor-pointer">
                Start Growth Trial
              </a>
            </div>
            ...
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-yellow-500 transition-all duration-300 hover:transform hover:scale-105">
              <div className="text-center mb-8">
                ...
                <p className="text-yellow-600 text-sm mt-2">Unlimited API access</p>
              </div>
          ...
          <div className="text-center mt-12 text-gray-400">
            <p>All plans include secure API connections and cover all platform API costs.</p>
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-8 text-sm">
              <div className="text-left bg-gray-800 p-6 rounded-xl">
                <h4 className="font-bold text-yellow-600 mb-3">Twitter API v2 Costs</h4>
              ...
              <div className="text-left bg-gray-800 p-6 rounded-xl">
                <h4 className="font-bold text-yellow-600 mb-3">Facebook Graph API Costs</h4>
                <ul className="space-y-2 text-gray-300">
            ...
            <p className="text-sm mt-6">* We handle all API complexities and costs - you just focus on creating content!</p>
          </div>
        </div>
      </section>
      ...
      <section id="connect" className="py-20 bg-black">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-8">
            <h3 className="text-2xl font-bold mb-6 text-center">Contact Methods</h3>
            ...
            <div className="rounded-2xl p-8">
              <h4 className="text-xl font-bold mb-6 text-center">Follow Us</h4>
      ...
      {/* CTA Section */}
      <section className={` bg-gray-950 text-center ${isShowingLogin ? "pt-20 pb-5" : "py-20" }`}>
        <div className="max-w-4xl mx-auto px-4">
          ...
          ""
          :
          <button id='signup' onClick={()=>handleFormOpen("signup")} className="signup-animation px-10 py-4 bg-yellow-600 text-black font-bold text-xl rounded-xl shadow-2xl hover:bg-yellow-500 transition cursor-pointer">
            Sign Up Now
          </button>}
        </div>
      </section>
      ...
      <Activity mode={isShowingLogin ? 'visible' : 'hidden'} >
                ...
                <div className="w-full flex justify-around max-w-md border border-b-0 bg-black border-yellow-600/30 rounded-t-2xl">
                  ...
                  <div className={`w-1/2  rounded-tl-2xl ${isSignUpOpen ? "bg-black" : "bg-gray-900"}`}>
                      <button onClick={()=>handleFormOpen("signup")} className={`cursor-pointer w-full text-2xl rounded-tl-2xl py-3 ${isSignUpOpen ? " bg-gray-900 rounded-tr-4xl text-yellow-500" : "bg-black rounded-br-4xl"}`}>Sign up</button>
                  </div>
                  
                  <div className={`w-1/2 rounded-tr-2xl ${isLoginOpen? "bg-black" : "bg-gray-900" }`}>
                      <button onClick={()=>handleFormOpen("login")} className={`cursor-pointer w-full text-2xl rounded-tr-2xl py-3 ${isLoginOpen ? "bg-gray-900 rounded-tl-4xl text-yellow-500": "bg-black  rounded-bl-4xl"}`}>Login</button>
                  </div>
                </div>
            ...
            <button 
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center">
                  <input type="checkbox" className="rounded bg-gray-800 border-gray-700 text-yellow-600 focus:ring-yellow-600" />
                  <span className="ml-2 text-sm text-gray-300">Remember me</span>
                </label>
                <button type="button" className="text-sm text-yellow-600 hover:text-yellow-500 transition">
                  Forgot password?
                </button>
              </div>
   ...
   <footer className="py-8 bg-gray-900 text-gray-400 border-t border-gray-800 text-center text-sm">
        ...
        <div className="mt-4 space-x-4">
          <a href="#" className="hover:text-indigo-500 cursor-pointer">Privacy Policy</a>
          <a href="#" className="hover:text-indigo-500 cursor-pointer">Terms of Service</a>
        </div>
      </footer>
    </>
